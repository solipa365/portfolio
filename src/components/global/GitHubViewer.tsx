...
const GitHubViewer = ({ isOpen, onClose }: GitHubViewerProps) => {
  ...
  return (
    <DraggableWindow
      title={showStructure ? selectedProject?.title || 'Projetos GitHub' : 'Projetos GitHub'}
      onClose={onClose}
      initialPosition={{ 
    ...
    >
      <div className="flex flex-col flex-grow min-h-0 h-full">
        <div className="overflow-y-auto flex-grow min-h-0 p-4 md:p-6">
          {!showStructure ? (
            <>
              <h2 className="text-2xl font-bold mb-4 text-gray-200">Meus Projetos</h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <h3 className="text-xl font-semibold mb-4 text-gray-200">Estrutura do Projeto</h3>
                ...
                {selectedProject && selectedProject.images && selectedProject.images.length > 0 && (
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    <h3 className="text-xl font-semibold mb-4 text-gray-200">Capturas de ecrã</h3>
                    ...
                    {selectedProject.repoUrl && (
                      <div className="mt-4">
                        ...
                        >
                          <FaGithub />
                          <span>Visite o repositório GitHub</span>
                        </a>
                      </div>
                    )}
                    {selectedProject.liveUrl && (
                      <div className="mt-4">
                        ...
                        >
                          <FaLink />
                          <span>Visite o site em direto</span>
                        </a>
                      </div>
                    )}
                  </div>
