      ...
      <div className='sticky top-0 z-50 hidden md:flex bg-black/20 backdrop-blur-md text-white h-6 px-4 items-center justify-between text-sm'>
        <div className='flex items-center space-x-4' ref={menuRef}>
          ...
          <div className="relative">
            ...
            {showSignature && (
              <div className="absolute top-full left-0 mt-1 bg-white/98 backdrop-blur-sm rounded-lg p-1 shadow-xl z-[100]">
                  <img 
                    src="https://avatars.githubusercontent.com/u/176431339?v=4" 
                    alt="Signature" 
